...
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="DumbedCode"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_EMAIL="code@DumbedCode.com"|export KEY_EMAIL="code@DumbedCode.com"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="DumbedCode"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="DumbedCode"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=DumbedCode|' /etc/openvpn/easy-rsa/vars
...
echo "~> Username: Enter your username"
